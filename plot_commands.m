...
interdomain_NM_DI = textread("Cry1Ab/Domains/domains_concat/Endotoxin_concat_NM_ranked_mapped.DI");
interdomain_NC_DI = textread("Cry1Ab/Domains/domains_concat/Endotoxin_concat_NC_ranked_mapped.DI");
interdomain_MC_DI = textread("Cry1Ab/Domains/domains_concat/Endotoxin_concat_MC_ranked_mapped.DI");
%%
plotDCAmap(monomer_6dj4, [], [1,600], 0, 1);
plotDCAmap(intradomain_N_DI(1:300, :), [], [1,600], 0, 0);
